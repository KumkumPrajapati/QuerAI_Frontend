...
function ChatWindow(){
    ...
    const getReply = async () =>{
        ...
        try{
                const response= await fetch("https://queryai-bacakend.onrender.com/api/chat", options);
    ...
    return(
        <div className="chatWindow">
            <div className="navbar">
                    <span>QueryAI <i className="fa-solid fa-chevron-down"></i></span>
            ...
            <div className="chatInput">
                   ...
                   <p className="info">
                        QueryAI can make mistakes. Check important info. See Cookie perferences.
                   </p>
            </div>
        </div>
    )
