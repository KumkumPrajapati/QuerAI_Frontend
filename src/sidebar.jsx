...
function Sidebar(){
    ...
    const toggleSidebar = () => setIsOpen(!isOpen);
     ...
     const getAllThreads = async () => {
        try {
            const response = await fetch("https://queryai-bacakend.onrender.com/api/thread");
    ...
    const changeThread = async (newThreadId) => {
        ...
        try {
            const response = await fetch(`https://queryai-bacakend.onrender.com/api/thread/${newThreadId}`);
            const res = await response.json();
            console.log(res);
            SetprevChats(res);
            console.log(res);
    ...
    const deleteThread = async (threadId) => {
        try {
            const response = await fetch(`https://queryai-bacakend.onrender.com/api/thread/${threadId}`, {method: "DELETE"});
            const res = await response.json();
            console.log(res);
    ...
    return(
        ...
        //     </button> */}
            ...
            <div className="sign">
                <p>By Kumkum Prajapati &hearts;</p>
            </div>
        </section>
        </>
    )
